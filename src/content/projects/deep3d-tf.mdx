...
<Image src={parallaxImg} alt="parallax" width="300" class="m-auto mt-4 mb-4" />
...
After some research, I came across Deep3D and felt like replicating the paper would be educational and a nice opportunity to learn a new ML framework and training models on a GPU.
...
<Image src={vggImg} alt="VGG network" width="500" class="m-auto mt-4 mb-4" />
...
<Image src={deep3DImg} alt="Deep3D network" width="500" class="m-auto mt-4 mb-4" />
<p class="text-center">(Deep3D Selection Layer)</p>

### Disparity Prediction


<Image src={deconvolutionImg} alt="Selection layer" width="600" class="m-auto mt-4 mb-4" />
...
<Image src={selectionImg} alt="Selection layer" width="400" class="m-auto mt-4 mb-4" />

<p class="text-center">([Tensorboard](https://www.tensorflow.org/tensorboard) renders a nice visualization of this custom layer)</p>
...
<Image src={horseImg} alt="gif of parallax effect on horse rider " width="500" class="m-auto mt-4 mb-4" />

<Image src={horseDepthImg} alt="gif of parallax effect on horse rider " width="500" class="m-auto mt-4 mb-4" />
<p class="text-center">(Estimated depth visualized)</p>

<Image src={hobbitImg} alt="gif of parallax effect on horse rider " width="500" class="m-auto mt-4 mb-4" />

<Image src={dancerImg} alt="gif of parallax effect on horse rider " width="500" class="m-auto mt-4 mb-4" />
